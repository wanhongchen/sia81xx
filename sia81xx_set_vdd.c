	...
	uint32_t channel_num) 
{
	...
	if (g_algo_is_v2) {
		...
		param_v2.proc_code = channel_num;
		param_v2.msg.vdd = vdd * 1000;

		/* don't set these in driver, it should be setted at acdb and it's fixed */
		param_v2.msg.p0 = VDD_MSG_INVALID_VAL;
		param_v2.msg.p1= VDD_MSG_INVALID_VAL;
		param_v2.msg.p2 = VDD_MSG_INVALID_VAL;
		param_v2.msg.p3= VDD_MSG_INVALID_VAL;
		param_v2.msg.p4 = VDD_MSG_INVALID_VAL;
